...
friends_routes.add_url_rule('/friends/suggestions', view_func=get_suggestions, methods=['GET'])
friends_routes.add_url_rule('/friends/<int:friend_id>/remove', view_func=delete_friend, methods=['DELETE'])